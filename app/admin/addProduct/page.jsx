    ...
    return (
        <>
            <form onSubmit={onSubmitHandler} className='pt-5 px-5 sm:pt-12 sm:pl-16'>
                ...
                <p className='text-xl mt-4'>Opinion</p>
                <textarea name='opinion' onChange={onChangeHandler} value={data.opinion} className='w-full sm:w-[500px] mt-4 px-4 py-3 border' placeholder='write content here' rows={4} required />
